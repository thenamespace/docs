---
description: Namespace Premier
---

# Welcome to Namespace Docs

<img
  src="images/CompressJPEG.Online_img(512x88).png"
  alt="Namespace logo"
  width="512"
/>
...
- [User? Start here →](user-guide/)
- [Developer? Start here →](developer-guide/)

---

## Products and Services

1. [Namespace App](user-guide/app)
2. [Dev Portal](user-guide/dev-app)
3. [SDK](developer-guide/sdks)
...
- [Offchain Manager](developer-guide/sdks/offchain-sdk): used for interacting with subnames, text records, data records, and API keys.
- [Mint Manager](developer-guide/sdks/mint-sdk): used for minting subnames under names that are activated on the Namespace platform.
- [Indexer Manager](developer-guide/sdks/indexer-sdk): used for interacting with indexed data from Namespace smart contracts.
...
- [FAQs](reference/faqs)
- [How the Infra Works](overview/how-infra-works)
