---
title: Wizard
description: Wizard handles activating ENS Names + Subname management, customization, and issuance.
---

# Wizard

**The Wizard is the core power tool of the Namespace platform.**

It lets you activate any ENS name you own and start issuing subnames—whether you want to sell them, gift them, rent them out, or use them to build community.
...
For more on the Namespace App, see the [Overview](../app).
