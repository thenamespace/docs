...
## Next steps
<CardGroup cols={2}>
  <Card title="Activate ENS Name (Required)" icon="toggle-on" href="/user-guide/app/activate-ens-name" arrow="true" />
  <Card title="Search & Register" icon="user-magnifying-glass" href="/user-guide/app/search-register" arrow="true" />
 </CardGroup>
