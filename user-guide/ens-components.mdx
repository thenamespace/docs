...
description: "Ready-made React interfaces for common ENS workflows."
...
<CardGroup cols={3}>
  ...
  <Card title="Skill.md" icon="robot" href="https://enscomponents.com/Skill.md">
    Agent-ready component instructions
  </Card>
</CardGroup>
...
- **Skill.md:** Give an AI agent the official [ENS Components instructions](https://enscomponents.com/Skill.md) directly.
- **Installable skill:** Add the [ENS components skill](/developer-guide/skills#ens-components-skill) to your project.
