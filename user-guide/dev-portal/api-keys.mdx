...
Easily generate an API key to programmatically manage Offchain subnames in your app, and enable Subname registrations in your project on the [Namespace App](https://app.namespace.ninja/offchain?activeTab=apiKeys) for your ENS name.

<Card title="Get API Key" icon="key" horizontal href="https://app.namespace.ninja/offchain?activeTab=apiKeys">
...
![Screenshot of the API Key generation interface in the Namespace App](/assets/api-keys.png)
...
<Tip>
  You can always revoke or regenerate your API keys from the Namespace App for enhanced security.
</Tip>