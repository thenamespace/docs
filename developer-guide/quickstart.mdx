...
<Tip>
  Audience: Developers. For a high-level overview and model selection (Offchain vs L2 vs L1), see <a href="/getting-started">
  Getting started</a>
</Tip>
...
<CardGroup cols={3}>
  ...
  <Card title="SDK Reference" icon="code" iconType="regular" href="developer-guide/sdks/introduction">
