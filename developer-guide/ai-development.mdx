...
description: These docs are LLM-friendly so you can use the latest models to build your applications. Access per-page and full-corpus text endpoints, and connect to our hosted Model Context Protocol (MCP) server.
---
...
- **MCP Server URL**: `https://namespace-1f56cc70.mintlify.app/mcp`
...
2. Use the URL `https://namespace-1f56cc70.mintlify.app/mcp`.
