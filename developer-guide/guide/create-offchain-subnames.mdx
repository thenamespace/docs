...
The repository contains a complete type-checked version at `examples/offchain-subnames.ts`. Documentation contributors can verify it with `npm run check:examples`.
