...
description: "A flexible starting point for branded minting sites."
...
Customize the website's appearance through `theme.json`, which contains the colors, backgrounds, and other visual tokens.
...
This creates a `dist` folder containing the static site. Deploy that folder to a compatible host such as Vercel, Netlify, or GitHub Pages.
