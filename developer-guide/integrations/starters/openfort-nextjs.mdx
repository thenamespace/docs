...
description: "A ready-to-run embedded-wallet identity flow."
...
- Namespace API key from the [Namespace App](/user-guide/dev-portal#create-an-api-key)
...
<Steps>
  ...
  <Step title="Namespace environment variables">
   ...
   2. Set your ENS name and Namespace API key (see [Namespace App API keys](/user-guide/dev-portal#create-an-api-key)):
