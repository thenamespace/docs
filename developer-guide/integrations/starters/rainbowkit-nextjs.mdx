...
sidebarTitle: "RainbowKit Starter (Offchain)"
icon: "rainbow"
---
...
**Repository:** [`thenamespace/offchain-next-rainbowkit-template`](https://github.com/thenamespace/offchain-next-rainbowkit-template)
...
Open `http://localhost:3000` to see the application.
  ...
  <img 
            src="/assets/developer-guide/integrations/rainbowkit-nextjs/page.png" 
            alt="Create subname interface with form to create a new offchain subname"
        />
  </Step>
...
- GitHub Repository: [`thenamespace/offchain-next-rainbowkit-template`](https://github.com/thenamespace/offchain-next-rainbowkit-template)
