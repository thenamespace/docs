...
description: "Compare three ENS subname integration paths for Wallet-as-a-Service providers."
...
- **ENS compatibility**: Compatible wallets and apps can resolve the resulting ENS records
...
**Use this path for**: Understanding the integration flow and testing the user experience
...
**Use this path for**: Issuing subnames directly to your users under a branded parent name.

Give users a readable name under your brand, such as `alice.wallet.eth`. Compatible ENS clients can resolve the records you attach to that subname.
...
Control this through your backend. Track usage and enforce limits before calling the Namespace API.

---

## 3. Ecosystem or Global Wallets

**Use this path for**: Allowing developers to bring their own ENS name and issue subnames to their users
...
- ✅ Resolution in compatible ENS clients
