...
description: "Learn how to add, update, and delete blockchain address records associated with ENS subnames."
...
<Note>
  <strong>Supported Chains:</strong> Check the <a href="/developer-guide/sdks/offchain-sdk/chainname">ChainName</a> page for the list of supported blockchain networks.
</Note>
