...
<Note>
  <strong>Label:</strong> The label of the subname follows the ENS naming convention. It follows UTS-46 encoding and can include emojis. See <a href="https://docs.ens.domains/ensip/15/">ENSIP-15</a> for more details.
</Note>
...
<Note>
The <code>ChainName</code> enum maps blockchain networks to their [SLIP-0044](https://github.com/satoshilabs/slips/blob/master/slip-0044.md) coin types for address records. See the [ChainName](/developer-guide/sdks/offchain-manager/chainname) page for more details.
</Note>
