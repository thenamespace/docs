...
<Note>
  <strong>Label:</strong> The label of the subname follows the ENS naming convention. It follows UTS-51 encoding and can include emojis. See <a href="https://docs.ens.domains/ensip/15/">ENSIP-15</a> for more details.
</Note>
