...
<Tabs>
  ...
  <Tab title="L1 chain">
    L1 subnames are fully decentralized, unruggable, and 100% under the users' control once minted. They are minted on the Ethereum mainnet at a higher cost. Fits premium, low-volume cases.
