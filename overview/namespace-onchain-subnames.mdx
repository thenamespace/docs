---
title: "Namespace Onchain Subnames"
description: "Overview of Namespace Onchain Subnames activation, minting, and resolution processes"
---

The **Namespace platform** enables ENS name owners to **activate** their names, allowing others to mint subnames under the activated parent. Owners have full flexibility to define custom activation parameters, including:
