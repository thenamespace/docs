...
<Tip>
  For a high-level overview and model selection (Offchain vs L2 vs L1), see <a href="/getting-started">Getting started</a>.
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="Offchain (Namespace App)" icon="cloud" href="/user-guide/dev-portal">
    Create and manage ENS Subnames offchain through the Namespace App. Add custom records, update the resolver contract, create API keys, and easily implement Subname registrations in your app.
  </Card>
</CardGroup>
...
<CardGroup cols={3}>
  <Card title="See sample projects" icon="folder-open" iconType="regular" href="developer-guide/guide">
...
- [Blog](https://www.namespace.ninja/blog)
